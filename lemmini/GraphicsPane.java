...
public class GraphicsPane extends JPanel
    ...
    private void redraw() {
        ...
        synchronized (paintSemaphore) {
            ...
            case INTRO:
                ...
                // offGfx.drawImage(LemmCursor.getImage(LemmCursor.TYPE_NORMAL),
                // LemmCursor.x,
                // LemmCursor.y, null);
                break;
            case BRIEFING:
            ...
            case LEVEL_END:
                if (bgImage != null) {
                    ...
                    // mouse movement
                    if (yMouseScreen > 40 && yMouseScreen < scoreY * scale) { // avoid
                                                                              // scrolling
                                                                              // if
                                                                              // menu
                                                                              // is
                        ...
                        if (xMouseScreen > this.getWidth()
                                - AUTOSCROLL_RANGE * scale) {
                            xOfsTemp = GameController.getxPos()
                                    + ((shiftPressed) ? X_STEP_FAST : X_STEP);

                            if (xOfsTemp < Level.WIDTH
                                    - this.getWidth() / scale) {
                                GameController.setxPos(xOfsTemp);
                            } else {
                                GameController.setxPos((int) Math.round(
                                        Level.WIDTH - this.getWidth() / scale));
                            }
                    ...
                    if (level != null) {
                        ...
                        // draw "behind" objects
                        GameController.getLevel().drawBehindObjects(offGfx, w,
                                xOfsTemp);

                        // draw background
                        offGfx.drawImage(bgImage, 0, 0, w, h, xOfsTemp, 0,
                                xOfsTemp + w, h, this);

                        // draw "in front" objects
                        GameController.getLevel().drawInFrontObjects(offGfx, w,
                                xOfsTemp);
                    }
                    ...
                    synchronized (GameController.getLemmings()) {
                        for (final Lemming l : lemmings) {
                            ...
                            if (lx + l.width() > xOfsTemp
                                    && lx < xOfsTemp + w) {
                                offGfx.drawImage(l.getImage(), lx - xOfsTemp,
                                        ly, null);
                                ...
                                if (cd != null) {
                                    offGfx.drawImage(cd, mx - xOfsTemp,
                                            ly - cd.getHeight(), null);
                                }
                    ...
                    offGfx.setClip(0, 0, w, h);
                    // draw explosions
                    GameController.drawExplosions(offGfx,
                            offImage[0].getWidth(), Level.HEIGHT, xOfsTemp);
                    offGfx.setClip(0, 0, w, this.getHeight());
                    ...
                    if (GameController.isCheat()) {
                        ...
                        sb.append("  IN ");
                        s = Integer.toString(GameController.getNumLeft() * 100
                        ...
                        sb.append(s);
                        sb.append("%  TIME ")
                                .append(GameController.getTimeString());
                        ...
                        if (lemmUnderCursor != null) {
                            ...
                            // the cursor
                            final int num = GameController.getLemmsUnderCursor()
                                    .size();
                    ...
                    // replay icon
                    final BufferedImage replayImage = GameController
                            .getReplayImage();
                    ...
                    if (lemmUnderCursor != null) {
                        ...
                        final BufferedImage cursorImg = LemmCursor
                                .getBoxImage();
    ...
    public void run() {
        ...
        try {
            while (true) {
                final GameController.State gameState = GameController
                        .getGameState();
    ...
    public void mousePressed(final MouseEvent mouseevent) {
        ...
        case BRIEFING:
            ...
            GameController
                    .setTransition(GameController.TransitionState.TO_LEVEL);
        ...
        case DEBRIEFING:
            ...
            case TextScreen.BUTTON_MENU:
                GameController
                        .setTransition(GameController.TransitionState.TO_INTRO);
                Fader.setState(Fader.State.OUT);
