...
public class Sprite {
    ...
    private void init(final Image sourceImg, final int animFrames) {
        ...
        triggered = false;
        // animation frames stored one above the other - now separate them into
        // single images
    ...
    /**
     * Replace one animation frame. Note: replacing with an image of different
     * size will create problems.
     *
     ...
     */
    public void setFrameIdx(final int frameIndex) {
