 ...
 * - if a key is pressed and released, a single SINGLE_CLICK is returned - if a
 * key is pressed for longer than timeFirstPress but not released, a
 * SINGLE_CLICK event is returned. Then if the key is still not released, each
 * timeRepeat microseconds, a new SINGLE_CLICK is returned. - if a key is
 * pressed, released and pressed again within timeDoubleClick microseconds, a
 * DOUBLE_CLICK is fired.
 *
 * @author Volker Oth
 */
public class KeyRepeat {
    ...
    private int mask;
    /**
     * time after which a pressed (and not released) key is recognized as key
     * press (microseconds).
     */
    ...
    /**
     * the maximum time between two clicks to be recognized as double click
     * (microseconds).
     */
     ...
     * Constructor.
     *
     * @param tfirst time after which a pressed (and not released) key is
     *               recognized as key press (microseconds)
     * @param trep   time for repeat function (microseconds)
     * @param tdc    maximum time between two clicks to be recognized as double
     *               click (microseconds)
     */
    ...
    public synchronized Event fired() {
        ...
        case DETECT_FIRST:
            ...
            break;
        case REPEAT:
            if (timer.timePassedUpdate(timeRepeat)) {
                return Event.SINGLE_CLICK;
            }
            break;
        default:
