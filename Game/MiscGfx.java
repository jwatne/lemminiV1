...
public class MiscGfx {
    ...
    public static void init(final Component frame) throws ResourceException {
        ...
        BufferedImage img;
        /* 0: BORDER */
        img = ToolBox.imageToBuffered(Core.loadImage("misc/border.gif", frame),
                Transparency.OPAQUE);
        images.add(img);
        /* 1: LEMMINI */
        img = ToolBox.imageToBuffered(Core.loadImageJar("lemmini.png", frame),
                Transparency.TRANSLUCENT);
        images.add(img);
        /* 2: TILE_GREEN */
        img = ToolBox.imageToBuffered(
                Core.loadImageJar("background.gif", frame),
                Transparency.OPAQUE);
        images.add(img);
        /* 3: TILE_BROWN */
        ...
        images.add(anim[1]);
        /* 6: SELECT */
        img = ToolBox.imageToBuffered(Core.loadImage("misc/select.gif", frame),
                Transparency.BITMASK);
        images.add(img);
