...
public class TextDialog {
	 ...
	 * 
	 * @param x0 x position of upper left corner of rectangle expressed in character
	 *           widths
	 * @param y0 y position of upper left corner of rectangle expressed in character
	 *           heights
	 ...
	 * @param id          Button ID
	 */
	public void addButton(final int x, final int y, final BufferedImage img, final BufferedImage imgSelected,
			final int id) {
	 ...
	 */
	public void addTextButton(final int x0, final int y0, final int id, final String t, final String ts,
